...
<head>
  ...
  <meta content="Aplikasi IoT untuk pengelolaan dan penjualan limbah logam di Desa Ngingas, Sidoarjo" name="description">
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:admin@silongas.com">admin@silongas.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+6211889232</span></i>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="index.html">SILONGAS<span></span></a></h1>
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="index.html">Home</a></li>
            <?php if (session()->get('level')): ?>
                <!-- Tampilkan tombol "Logout" atau logika lainnya ketika pengguna sudah login -->
                <li><a class="nav-link scrollto" href="<?= base_url('auth/logout') ?>">Login</a></li>
            <?php else: ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Jl. Contoh No.1<br>
              Desa Ngingas, Sidoarjo<br>
              Indonesia <br><br>
              <strong>Phone:</strong> +6211889232<br>
